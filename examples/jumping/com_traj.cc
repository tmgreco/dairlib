...
CoMTraj::CoMTraj(const RigidBodyTree<double> &tree, int hip_idx,
    ...
    : tree_(tree), hip_idx_(hip_idx), left_foot_idx_(left_foot_idx),
      right_foot_idx_(right_foot_idx), crouch_traj_(crouch_traj),
      height_(height) {
...
EventStatus
CoMTraj::DiscreteVariableUpdate(const Context<double> &context,
...
CoMTraj::generateNeutralTraj(const drake::systems::Context<double> &context,
...
PiecewisePolynomial<double>
CoMTraj::generateCrouchTraj(const drake::systems::Context<double> &context,
                            VectorXd &q, VectorXd &v) const {
...
PiecewisePolynomial<double>
CoMTraj::generateLandingTraj(const drake::systems::Context<double> &context,
                             VectorXd &q, VectorXd &v) const {
