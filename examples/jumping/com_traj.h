...
private:
  PiecewisePolynomial<double> generateNeutralTraj( const drake::systems::Context<double>& context,
                                                  VectorXd& q, VectorXd& v) const;
  PiecewisePolynomial<double> generateCrouchTraj( const drake::systems::Context<double>& context,
                                                  VectorXd& q, VectorXd& v) const; 
  PiecewisePolynomial<double> generateFlightTraj( const drake::systems::Context<double>& context,
                                                  VectorXd& q, VectorXd& v) const;
  PiecewisePolynomial<double> generateLandingTraj( const drake::systems::Context<double>& context,
                                                  VectorXd& q, VectorXd& v) const;
