...
void SpiritBoundingGait<Y>::generateInitialGuess(MultibodyPlant<Y>& plant){
  ...
  this->x_traj=PiecewisePolynomial<double>::FirstOrderHold({0 * duration/3.0, 1* duration/3.0},x_points);
  x_points.clear();
  ...
  x_points.push_back(x_const);
  PiecewisePolynomial<double> x_traj_2=PiecewisePolynomial<double>::FirstOrderHold({0 * duration/3.0, 1 * duration/3.0},x_points);
  x_traj_2.shiftRight(this->x_traj.end_time());
  this->x_traj.ConcatenateInTime(x_traj_2);
  x_points.clear();
  ...
  x_points.push_back(x_const);
  PiecewisePolynomial<double> x_traj_3=PiecewisePolynomial<double>::FirstOrderHold({0 * duration/3.0, 1 * duration/3.0},x_points);
  x_traj_3.shiftRight(this->x_traj.end_time());
  this->x_traj.ConcatenateInTime(x_traj_3);
  x_points.clear();
  ...
  x_points.push_back(x_const);
  PiecewisePolynomial<double> x_traj_3td=PiecewisePolynomial<double>::FirstOrderHold({0 * duration/3.0, 1 * duration/3.0},x_points);
  x_traj_3td.shiftRight(this->x_traj.end_time());
  this->x_traj.ConcatenateInTime(x_traj_3td);
  x_points.clear();
  ...
  PiecewisePolynomial<double> x_traj_4=PiecewisePolynomial<double>::FirstOrderHold({0 * duration/3.0, 1 * duration/3.0},x_points);
  x_traj_4.shiftRight(this->x_traj.end_time());
  this->x_traj.ConcatenateInTime(x_traj_4);
  x_points.clear();
  ...
  PiecewisePolynomial<double> x_traj_5=PiecewisePolynomial<double>::FirstOrderHold({0 * duration/3.0, 1 * duration/3.0},x_points);
  x_traj_5.shiftRight(this->x_traj.end_time());
  this->x_traj.ConcatenateInTime(x_traj_5);
  x_points.clear();
  ...
  /// Animate the initial trajectory
  ...
  std::cout << "animating 2 times." << std::endl;
  for (int i = 0; i <2; i++ ) {
...
// Get position and velocity dictionaries
  ...
  trajopt.AddBoundingBoxConstraint( this->apex_height-eps, this->apex_height+eps, x0( positions_map.at("base_z")));
  ...
  if (lock_leg_apex){
    ...
    double hipSet = 0.1;
    double freedom=60;
    trajopt.AddBoundingBoxConstraint(upperSet - freedom*eps, upperSet + freedom*eps, x0(positions_map.at("joint_0") ) );
    trajopt.AddBoundingBoxConstraint(kneeSet - freedom*eps, kneeSet + freedom*eps, x0(positions_map.at("joint_1") ) );

    trajopt.AddBoundingBoxConstraint(upperSet - freedom*eps, upperSet + freedom*eps, x0(positions_map.at("joint_2") ) );
    trajopt.AddBoundingBoxConstraint(kneeSet - freedom*eps, kneeSet + freedom*eps, x0(positions_map.at("joint_3") ) );

    trajopt.AddBoundingBoxConstraint(upperSet - freedom*eps, upperSet + freedom*eps, x0(positions_map.at("joint_4") ) );
    trajopt.AddBoundingBoxConstraint(kneeSet - freedom*eps, kneeSet + freedom*eps, x0(positions_map.at("joint_5") ) );

    trajopt.AddBoundingBoxConstraint(upperSet - freedom*eps, upperSet + freedom*eps, x0(positions_map.at("joint_6") ) );
    trajopt.AddBoundingBoxConstraint(kneeSet - freedom*eps, kneeSet + freedom*eps, x0(positions_map.at("joint_7") ) );

    trajopt.AddBoundingBoxConstraint(upperSet - freedom*eps, upperSet + freedom*eps, xapex(positions_map.at("joint_0") ) );
    trajopt.AddBoundingBoxConstraint(kneeSet - freedom*eps, kneeSet + freedom*eps, xapex(positions_map.at("joint_1") ) );

    trajopt.AddBoundingBoxConstraint(upperSet - freedom*eps, upperSet + freedom*eps, xapex(positions_map.at("joint_2") ) );
    trajopt.AddBoundingBoxConstraint(kneeSet - freedom*eps, kneeSet + freedom*eps, xapex(positions_map.at("joint_3") ) );

    trajopt.AddBoundingBoxConstraint(upperSet - freedom*eps, upperSet + freedom*eps, xapex(positions_map.at("joint_4") ) );
    trajopt.AddBoundingBoxConstraint(kneeSet - freedom*eps, kneeSet + freedom*eps, xapex(positions_map.at("joint_5") ) );

    trajopt.AddBoundingBoxConstraint(upperSet - freedom*eps, upperSet + freedom*eps, xapex(positions_map.at("joint_6") ) );
    trajopt.AddBoundingBoxConstraint(kneeSet - freedom*eps, kneeSet + freedom*eps, xapex(positions_map.at("joint_7") ) );

    trajopt.AddBoundingBoxConstraint(hipSet - freedom*eps, hipSet + freedom*eps, x0(positions_map.at("joint_8") ) );
    trajopt.AddBoundingBoxConstraint(hipSet - freedom*eps, hipSet + freedom*eps, x0(positions_map.at("joint_9") ) );
    trajopt.AddBoundingBoxConstraint(hipSet - freedom*eps, hipSet + freedom*eps, x0(positions_map.at("joint_10") ) );
    trajopt.AddBoundingBoxConstraint(hipSet - freedom*eps, hipSet + freedom*eps, x0(positions_map.at("joint_11") ) );
    trajopt.AddBoundingBoxConstraint(hipSet - freedom*eps, hipSet + freedom*eps, xapex(positions_map.at("joint_8") ) );
    trajopt.AddBoundingBoxConstraint(hipSet - freedom*eps, hipSet + freedom*eps, xapex(positions_map.at("joint_9") ) );
    trajopt.AddBoundingBoxConstraint(hipSet - freedom*eps, hipSet + freedom*eps, xapex(positions_map.at("joint_10") ) );
    trajopt.AddBoundingBoxConstraint(hipSet - freedom*eps, hipSet + freedom*eps, xapex(positions_map.at("joint_11") ) );
...
void SpiritBoundingGait<Y>::setUpModeSequence(){
  ...
  this->addModeToSequenceVector("front_stance",Eigen::Vector3d::UnitZ(),Eigen::Vector3d::Zero(),0.04, 1);
  this->addModeToSequenceVector("flight",Eigen::Vector3d::UnitZ(),Eigen::Vector3d::Zero(),0.02, 1);
  this->addModeToSequenceVector("flight",Eigen::Vector3d::UnitZ(),Eigen::Vector3d::Zero(),0.02, 1);
  this->addModeToSequenceVector("rear_stance",Eigen::Vector3d::UnitZ(),Eigen::Vector3d::Zero(),0.04, 1);
  this->addModeToSequenceVector("flight",Eigen::Vector3d::UnitZ(),Eigen::Vector3d::Zero(),0.04, 1);
}
...
void SpiritBoundingGait<Y>::run(MultibodyPlant<Y>& plant,
  ...
  if (this->file_name_in.empty()){
    ...
    std::cout<<this->x_traj.end_time()<<" "<<this->x_traj.end_time()<<std::endl;
