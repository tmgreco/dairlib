...
int main(int argc, char* argv[]) {
    ...
    if(const char* env_p = std::getenv("DAIRLIB_PATH")){
        ...
        // dairlib::Spirit<dairlib::SpiritParkourWallPronk,double> my_spirit("/home/feng/Downloads/dairlib/examples/Spirit_spine/yaml_configs/parkour_wall_config_1s.yaml");
